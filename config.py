...
class Config:
    def __init__(self):
        ...
        self.temperature = decimal.Decimal(os.getenv("TEMPERATURE", 0.7))  # Default to 0.7 if not set decimal.Decimal(os.getenv("TEMPERATURE", 0))  # Default to 0.7 if not set
